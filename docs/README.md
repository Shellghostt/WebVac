...
|----------|-------------|
| [ARCHITECTURE.md](ARCHITECTURE.md) | Full system architecture — layers, runtime sequence, package map, status |
| [architecture/AUTH.md](architecture/AUTH.md) | AuthManager, engines, sessions, MFA, walls, bootstrap |
